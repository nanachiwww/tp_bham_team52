...
/**
 * REST controller for managing {@link team.bham.domain.Dashboard}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DashboardResource {
    ...
    public ResponseEntity<Dashboard> partialUpdateDashboard(
        ...
        Optional<Dashboard> result = dashboardRepository
            ...
            .map(existingDashboard -> {
                if (dashboard.getOverview() != null) {
                    existingDashboard.setOverview(dashboard.getOverview());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dashboard.getId().toString())
        );
    }
