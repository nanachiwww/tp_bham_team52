...
type ItemFormDefaults = Pick<NewItem, 'id' | 'energyIntakeResults'>;

type ItemFormGroupContent = {
  id: FormControl<IItem['id'] | NewItem['id']>;
  itemName: FormControl<IItem['itemName']>;
  category: FormControl<IItem['category']>;
  energyIntakeResults: FormControl<IItem['energyIntakeResults']>;
  userProfile: FormControl<IItem['userProfile']>;
};
...
export class ItemFormService {
  createItemFormGroup(item: ItemFormGroupInput = { id: null }): ItemFormGroup {
    ...
    return new FormGroup<ItemFormGroupContent>({
      ...
      energyIntakeResults: new FormControl(itemRawValue.energyIntakeResults ?? []),
      userProfile: new FormControl(itemRawValue.userProfile),
    });
  }
