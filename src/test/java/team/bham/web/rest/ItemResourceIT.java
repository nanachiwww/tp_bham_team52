...
class ItemResourceIT {
    ...
    private static final CategoriesEnum DEFAULT_CATEGORY = CategoriesEnum.BREAKFAST;
    private static final CategoriesEnum UPDATED_CATEGORY = CategoriesEnum.LUNCH;
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().itemName(DEFAULT_ITEM_NAME).category(DEFAULT_CATEGORY);
        return item;
    }
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().itemName(UPDATED_ITEM_NAME).category(UPDATED_CATEGORY);
        return item;
    }
    ...
    void putExistingItem() throws Exception {
        ...
        updatedItem.itemName(UPDATED_ITEM_NAME).category(UPDATED_CATEGORY);
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.itemName(UPDATED_ITEM_NAME).category(UPDATED_CATEGORY);
